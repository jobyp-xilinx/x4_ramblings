...
fw_version=$($XAM build_versions --product mcfw_x4.a0.stage2_veloce --report-path | tail -n1)
...
rtl_version=$($XAM build_versions --product rtl_x4.stage2_veloce --report-path | tail -n1)
