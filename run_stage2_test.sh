...
if [[ -z "${MANIFEST}" ]]; then 
    velocetool setup --rtl ./rtl_x4.stage2_pcie_veloce --snapper ./snapper_x4 --firmware ./mcfw_x4.a0.stage2_veloce --tools ./tools.x86_64 --fw-variant ${VARIANT} # --pcie-trace
...
do
    ...
    ssh_vm "cd /tmp/snapper_x4/snapper; ./snap -- -V -V -V ${TEST}"  2>&1 | tee -a snapper_${TEST}_${VARIANT}.log
